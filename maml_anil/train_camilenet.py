...
def main(
    ...
    use_cuda=1,
    seed=42,
    number_train_tasks=200000,
    number_valid_tasks=6000,
    number_test_tasks=6000,
    patience=10,
    ...
    for iteration in range(iterations):
        ...
        logging.info(f"Meta Train Error: {avg_train_error:.4f}")
        ...
        logging.info(f"Meta Val Error: {meta_valid_error:.4f}")
        ...
        if meta_valid_error < best_meta_val_error:
            ...
            patience_counter += 1
            logging.info(f"No improvement in meta-test error. Patience: {patience_counter}")
